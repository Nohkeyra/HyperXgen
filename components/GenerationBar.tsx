...
export const GenerationBar: React.FC<GenerationBarProps> = ({ 
  ...
  return (
    <div className={`w-full border-t-2 transition-colors duration-500 border-brandRed bg-brandNeutral dark:bg-brandDeep shadow-[0_-10px_30px_rgba(0,0,0,0.5)] z-50 rounded-sm py-2 px-3 md:py-4 md:px-6`}>
      <div className={`max-w-screen-2xl mx-auto flex flex-col md:flex-row items-stretch gap-0 border-2 transition-all duration-500 border-brandCharcoal dark:border-white/20 shadow-[2px_2px_0px_0px_#FD1E4A] md:shadow-[4px_4px_0px_0px_#FD1E4A] bg-white dark:bg-black/60 overflow-hidden`}>
